...
CI parses the `SKILL.md` frontmatter and runs the scripts against `examples/`. There is no automated evaluation of the generated notes themselves, so describe your actual checks in the pull request.
